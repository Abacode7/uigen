          ...
          <ResizablePanelGroup direction="horizontal" className="h-full">
            ...
            <ResizablePanel defaultSize={65}>
              ...
              >
                ...
                {/* Content Area */}
                <TabsContent value="preview" className="flex-1 overflow-hidden bg-neutral-50 m-0 h-full">
                  <div className="h-full bg-white">
                    <PreviewFrame />
                  </div>
                </TabsContent>

                <TabsContent value="code" className="flex-1 overflow-hidden bg-neutral-50 m-0 h-full">
                  <ResizablePanelGroup
